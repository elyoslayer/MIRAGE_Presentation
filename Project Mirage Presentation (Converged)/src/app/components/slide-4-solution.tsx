    ...
    <div className="w-full h-screen flex flex-col items-center justify-center relative overflow-hidden p-4 md:p-16">
      ...
      >
        <h2
          ...
          style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 300, fontSize: "clamp(1rem, 3.5vw, 2.5rem)" }}
        >
          NEXUS ARCHITECTURE
        </h2>
      </motion.div>

      {/* Flow Chart - Desktop Horizontal */}
      <div className="hidden md:flex relative w-full max-w-6xl items-center justify-between">
        {/* Input */}
      ...
      {/* Flow Chart - Mobile Vertical */}
      <div className="md:hidden flex flex-col items-center w-full max-w-[240px] gap-2 overflow-y-auto">
        {/* Input - Mobile */}
        <GlassCard className="p-4 w-full text-center" delay={0.2}>
          <div className="flex flex-col items-center gap-2">
            <svg width="45" height="45" viewBox="0 0 100 100" fill="none">
              {/* Data Cube - reuse from desktop but smaller */}
              <motion.g
                initial={{ opacity: 0, scale: 0.5 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.6, delay: 0.3 }}
              ...
              <motion.g
                ...
                transition={{ duration: 0.4, delay: 1.2 }}
              >
                <rect x="42" y="48" width="16" height="12" rx="2" fill="rgba(11, 16, 33, 0.9)" stroke="#FF5252" strokeWidth="1.5" />
                <path d="M 45 48 L 45 43 Q 45 38 50 38 Q 55 38 55 43 L 55 48" fill="none" stroke="#FF5252" strokeWidth="1.5" />
                <circle cx="50" cy="54" r="1.5" fill="#FF5252" />
              </motion.g>
            </svg>
            <p className="text-white tracking-[0.1em] text-xs" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
              STRUCTURED DATA
            </p>
        ...
        {/* Vertical Flow Line 1 - Mobile */}
        {flowStarted && (
          <motion.div className="relative w-1 h-8">
            <motion.div
              initial={{ scaleY: 0 }}
              animate={{ scaleY: 1 }}
              transition={{ duration: 0.6 }}
              className="w-full h-full origin-top bg-gradient-to-b from-[#00E5FF] to-[#9D4EDD]"
            />
            {[...Array(1)].map((_, i) => (
              <motion.div
                key={i}
                ...
                className="absolute left-1/2 transform -translate-x-1/2 w-1.5 h-1.5 bg-[#00E5FF] rounded-full"
                style={{
        ...
        {/* TEE Engine - Mobile */}
        <GlassCard className="p-4 w-full text-center relative z-10" delay={0.4}>
          <div className="flex flex-col items-center gap-2">
            <svg width="40" height="40" viewBox="0 0 100 100" fill="none">
              <rect x="10" y="10" width="80" height="80" fill="rgba(157, 78, 221, 0.05)" rx="4" />
              <motion.circle cx="50" cy="50" r="8" stroke="#9D4EDD" strokeWidth="2" fill="rgba(157, 78, 221, 0.2)" initial={{ scale: 0.8 }} animate={{ scale: [0.8, 1.1, 0.8] }} transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }} />
              <motion.circle cx="50" cy="50" r="4" fill="#9D4EDD" initial={{ opacity: 0.5 }} animate={{ opacity: [0.5, 1, 0.5] }} transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }} />
              <motion.circle cx="50" cy="50" r="15" stroke="#9D4EDD" strokeWidth="1.5" fill="none" initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: [0.9, 1.2, 0.9], opacity: [0, 0.6, 0] }} transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }} />
            </svg>
            <p className="text-white tracking-[0.1em] text-xs" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
              GenAI Engine
            </p>
            <p className="text-[#9D4EDD] text-[10px]" style={{ fontFamily: "'Inter', sans-serif" }}>
              Security & Compliance by Design
            </p>
          </div>
          <motion.div
            ...
            transition={{ duration: 2, repeat: Infinity }}
            className="absolute inset-0 rounded-lg border border-[#9D4EDD]"
            style={{ boxShadow: "0 0 20px rgba(157, 78, 221, 0.5)" }}
          />
        </GlassCard>
        ...
        <div className="flex flex-col items-center gap-1.5 w-full">
          {flowStarted && (
            <motion.div className="relative w-1 h-6">
              <motion.div
                initial={{ scaleY: 0 }}
                animate={{ scaleY: 1 }}
                transition={{ duration: 0.6, delay: 0.8 }}
                className="w-full h-full origin-top bg-[#9D4EDD]"
              />
            </motion.div>
          )}
          <GlassCard className="p-3 w-full text-center" delay={1}>
            <svg width="32" height="32" viewBox="0 0 60 60" fill="none" className="mx-auto mb-1.5">
              <defs>
                <filter id="binaryGlowMobile" x="-50%" y="-50%" width="200%" height="200%">
                  <feGaussianBlur stdDeviation="1.5" result="coloredBlur" />
                  <feMerge>
                    <feMergeNode in="coloredBlur" />
                    <feMergeNode in="SourceGraphic" />
              ...
              {['1', '0', '1', '1', '0', '1', '0'].map((bit, i) => (
                <motion.text
                  ...
                  fontSize="7"
                  fontFamily="'JetBrains Mono', monospace"
                  filter="url(#binaryGlowMobile)"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: [0, 0.9, 1, 0.9, 0] }}
                  transition={{
                    duration: 4,
                    delay: i * 0.15,
                    repeat: Infinity,
          ...
          {flowStarted && (
            <motion.div className="relative w-1 h-6">
              <motion.div
                ...
                style={{
                  background: "linear-gradient(180deg, rgba(157, 78, 221, 0.3) 0%, rgba(157, 78, 221, 0.1) 100%)",
                }}
              />
            </motion.div>
          )}
          <GlassCard className="p-3 w-full text-center opacity-60" delay={1.4}>
            <svg width="32" height="32" viewBox="0 0 60 60" fill="none" className="mx-auto mb-1.5">
              <defs>
                <filter id="laserGlowMobile" x="-50%" y="-50%" width="200%" height="200%">
                  <feGaussianBlur stdDeviation="1.5" result="coloredBlur" />
                  <feMerge>
                    <feMergeNode in="coloredBlur" />
                    <feMergeNode in="SourceGraphic" />
              ...
              <rect x="4" y="18" width="5" height="5" fill="#FF5252" rx="1" />
              <rect x="51" y="18" width="5" height="5" fill="#FF5252" rx="1" />
              <rect x="4" y="36" width="5" height="5" fill="#FF5252" rx="1" />
              <rect x="51" y="36" width="5" height="5" fill="#FF5252" rx="1" />
              <line x1="9" y1="20.5" x2="51" y2="20.5" stroke="#FF5252" strokeWidth="1.2" opacity="0.4" filter="url(#laserGlowMobile)" />
              <line x1="9" y1="38.5" x2="51" y2="38.5" stroke="#FF5252" strokeWidth="1.2" opacity="0.4" filter="url(#laserGlowMobile)" />
              {[...Array(2)].map((_, i) => (
                <motion.circle
                  key={`laser-mobile-${i}`}
                  cy="20.5"
