...
export function Slide7Pillars() {
  ...
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center relative overflow-hidden p-4 md:p-16 pt-20 md:pt-32">
      {/* Title */}
      <motion.div
        initial={{ opacity: 0, y: -30 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8 }}
        className="mb-8 md:mb-16 mt-8 md:mt-12"
      >
        <h2
      ...
      {/* Pillars - Desktop Horizontal, Mobile Vertical */}
      <div className="flex flex-col md:flex-row gap-6 md:gap-8 w-full max-w-6xl overflow-y-auto md:overflow-y-visible px-2 md:px-0" style={{ maxHeight: "calc(100vh - 180px)" }}>
        {pillars.map((pillar, index) => (
          ...
          >
            <GlassCard className="p-6 md:p-8 h-auto md:h-[450px] flex flex-col items-center" delay={pillar.delay} hover={true}>
              {/* Icon */}
              <motion.div
                animate={{
                  y: [0, -10, 0],
              ...
              {/* Title */}
              <h3
                className="tracking-[0.15em] mb-4 text-center"
                style={{
