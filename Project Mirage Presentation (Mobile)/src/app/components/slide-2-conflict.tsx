    ...
    <div className="w-full h-screen flex items-center justify-center relative overflow-hidden p-4 md:p-8">
      <div className="w-full max-w-7xl h-full flex flex-col md:flex-row items-center justify-center gap-0 relative">
        ...
        <motion.div
          ...
          className="absolute top-24 md:top-20 left-1/2 transform -translate-x-1/2 text-center z-20 px-4"
        >
          <h2
            className="text-white tracking-[0.15em] md:tracking-[0.2em]"
            style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 300, fontSize: "clamp(1.25rem, 5vw, 2.5rem)" }}
          >
        ...
        {/* MOBILE LAYOUT */}
        <div className="flex md:hidden flex-col w-full h-full items-center justify-center gap-2 pt-28">
          {/* The Vault - Mobile */}
          <motion.div
          ...
          >
            {/* Vault Icon */}
            <div className="relative scale-[0.67]">
              <VaultSVG />
            </div>
            <motion.p
              initial={{ opacity: 0 }}
              ...
              className="text-white tracking-[0.12em] mt-4"
              style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 300, fontSize: "1.4rem" }}
            >
              THE VAULT
            </motion.p>
            <motion.p
          ...
          <motion.div
            ...
            className="h-[2px] w-4/5 max-w-md relative origin-center my-2"
            style={{
              background: "linear-gradient(90deg, transparent 0%, #FF5252 50%, transparent 100%)",
              boxShadow: "0 0 20px rgba(255, 82, 82, 0.8)",
            }}
          />

          {/* Data Paralysis Label - Mobile */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 0.8, delay: 1.2 }}
            className="bg-[#FF5252]/20 border border-[#FF5252]/40 px-4 py-2 rounded backdrop-blur-xl text-center my-2"
          >
            <p
              className="text-[#FF5252] tracking-[0.12em]"
          ...
          {/* Second Horizontal Divider Line - Mobile */}
          <motion.div
            initial={{ scaleX: 0, opacity: 0 }}
            animate={{ scaleX: 1, opacity: 1 }}
          ...
          {/* The Laboratory - Mobile */}
          <motion.div
            initial={{ opacity: 0, y: 50 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
            className="flex flex-col items-center justify-center py-2 mt-4"
          >
            {/* Laboratory Icon */}
            <div className="relative scale-[0.84] mb-2">
              <LaboratorySVG />
            </div>
            <motion.p
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 0.6, delay: 0.5 }}
              className="text-white tracking-[0.12em] mt-6"
              style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 300, fontSize: "1.4rem" }}
            >
              THE LABORATORY
            </motion.p>
        ...
        {/* DESKTOP LAYOUT */}
        <div className="hidden md:flex w-full h-full items-center gap-0">
          {/* Left Side - The Vault - Desktop */}
          <motion.div
          ...
          >
            ...
            <motion.p
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.5 }}
              className="mt-8 text-white tracking-[0.15em]"
          ...
          {/* Right Side - The Laboratory - Desktop */}
          <motion.div
            initial={{ x: 100, opacity: 0 }}
            animate={{ x: 0, opacity: 1 }}
            transition={{ duration: 0.8 }}
          ...
          >
            ...
            <motion.p
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.5 }}
              className="mt-6 text-white tracking-[0.15em]"
              style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 300, fontSize: "1.5rem" }}
            >
              THE LABORATORY
            </motion.p>
        ...
        return (
          <motion.div
            ...
            style={{
              ...
              marginLeft: `${x}px`,
              marginTop: `${y}px`,
              background: i % 2 === 0 ? "#00B8D4" : "#FF5252",
