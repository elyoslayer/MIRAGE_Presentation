  ...
  return (
    <div className="w-full h-screen flex items-center justify-center relative overflow-hidden p-16">
      <div className="w-full max-w-7xl flex gap-16 items-center">
        ...
        >
          <h2
            className="text-white tracking-[0.2em] mb-8"
            style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 300, fontSize: "2.5rem" }}
          >
            FROM PARALYSIS<br />TO SOVEREIGNTY
          </h2>

          <div className="w-32 h-[2px] bg-gradient-to-r from-[#00E5FF] to-transparent mb-8" />

          <p
            className="text-white/70 tracking-[0.1em] leading-relaxed mb-8"
        ...
        <div className="flex-1 relative">
          {/* Laser Beam Line */}
          <svg className="absolute left-8 top-0 bottom-0" width="4" height="100%">
            <defs>
            ...
            {milestones.map((milestone, index) => (
              ...
              >
                <GlassCard className="p-6 relative" delay={milestone.delay}>
                  ...
                  <div className="absolute -left-[46px] top-1/2 transform -translate-y-1/2 -translate-x-1/2">
                    {/* Outer Pulsing Ring */}
                    <motion.div
