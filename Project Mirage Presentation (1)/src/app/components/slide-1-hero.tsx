  ...
  return (
    <div className="w-full h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute flex flex-col items-center gap-6 z-10"
      >
        <h1
          className="tracking-[0.3em] text-white"
          style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 300, fontSize: "5rem" }}
        >
          PROJECT MIRAGE
        </h1>
        <motion.div
          initial={{ width: 0 }}
          animate={animate ? { width: "400px" } : {}}
          transition={{ duration: 0.6, delay: 2 }}
          className="h-[1px] bg-gradient-to-r from-transparent via-[#00E5FF] to-transparent"
        />
        <p
          className="text-[#00E5FF] tracking-[0.2em]"
          style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, fontSize: "1.5rem" }}
        >
        ...
        <motion.p
          ...
          className="text-white/70 tracking-[0.15em] mt-4"
