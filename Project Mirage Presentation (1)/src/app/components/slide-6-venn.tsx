  ...
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center relative overflow-hidden p-16">
      ...
      >
        ...
        <p
          className="text-white/70 text-center tracking-[0.15em]"
          style={{ fontFamily: "'Inter', sans-serif", fontSize: "1.2rem", marginTop: "calc(1rem - 3vh)" }}
        >
      ...
      {/* Venn Diagram */}
      <div className="relative w-[800px] h-[500px] -mt-16" style={{ marginTop: "calc(-4rem - 7vh + 4vh)" }}>
